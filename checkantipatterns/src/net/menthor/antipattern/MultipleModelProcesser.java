...
public class MultipleModelProcesser {
	...
	public static List<Antipattern<?>> createApList(OntoUMLParser parser,String antiPatternsChecked) {
		List<Antipattern<?>> apList = new ArrayList<Antipattern<?>>(); 
		if(antiPatternsChecked.contains("ASSCYCANTIPATTERN")) apList.add(new AssCycAntipattern(parser));
		if(antiPatternsChecked.contains("BINOVERANTIPATTERN"))apList.add(new BinOverAntipattern(parser));
		if(antiPatternsChecked.contains("DECINTANTIPATTERN"))apList.add(new DecIntAntipattern(parser));
		if(antiPatternsChecked.contains("DEPPHASEANTIPATTERN"))apList.add(new DepPhaseAntipattern(parser));
		if(antiPatternsChecked.contains("FREEROLEANTIPATTERN"))apList.add(new FreeRoleAntipattern(parser));
		if(antiPatternsChecked.contains("GSRIGANTIPATTERN"))apList.add(new GSRigAntipattern(parser));
		if(antiPatternsChecked.contains("HETCOLLANTIPATTERN"))apList.add(new HetCollAntipattern(parser));
		if(antiPatternsChecked.contains("HOMOFUNCANTIPATTERN"))apList.add(new HomoFuncAntipattern(parser));
		if(antiPatternsChecked.contains("IMPABSANTIPATTERN"))apList.add(new ImpAbsAntipattern(parser));
		if(antiPatternsChecked.contains("MIXIDENANTIPATTERN"))apList.add(new MixIdenAntipattern(parser));
		if(antiPatternsChecked.contains("MIXRIGANTIPATTERN"))apList.add(new MixRigAntipattern(parser));
		if(antiPatternsChecked.contains("MULTIDEPANTIPATTERN"))apList.add(new MultiDepAntipattern(parser));
		if(antiPatternsChecked.contains("PARTOVERANTIPATTERN"))apList.add(new PartOverAntipattern(parser));
		if(antiPatternsChecked.contains("RELCOMPANTIPATTERN"))apList.add(new RelCompAntipattern(parser));
		if(antiPatternsChecked.contains("RELOVERANTIPATTERN"))apList.add(new RelOverAntipattern(parser));
		if(antiPatternsChecked.contains("RELRIGANTIPATTERN"))apList.add(new RelRigAntipattern(parser));
		if(antiPatternsChecked.contains("RELSPECANTIPATTERN"))apList.add(new RelSpecAntipattern(parser));
		if(antiPatternsChecked.contains("REPRELANTIPATTERN"))apList.add(new RepRelAntipattern(parser));
		if(antiPatternsChecked.contains("UNDEFFORMALANTIPATTERN"))apList.add(new UndefFormalAntipattern(parser));
		if(antiPatternsChecked.contains("UNDEFPHASEANTIPATTERN"))apList.add(new UndefPhaseAntipattern(parser));
		if(antiPatternsChecked.contains("WHOLEOVERANTIPATTERN"))apList.add(new WholeOverAntipattern(parser));
		return apList;
	}
